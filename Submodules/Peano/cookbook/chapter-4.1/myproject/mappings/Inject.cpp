...
peano::CommunicationSpecification   myproject::mappings::Inject::communicationSpecification() const {
...
peano::MappingSpecification   myproject::mappings::Inject::touchVertexLastTimeSpecification(int leve) const {
...
peano::MappingSpecification   myproject::mappings::Inject::touchVertexFirstTimeSpecification(int leve) const { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}
peano::MappingSpecification   myproject::mappings::Inject::enterCellSpecification(int leve) const {
...
peano::MappingSpecification   myproject::mappings::Inject::leaveCellSpecification(int leve) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidFineGridRaces,true);
}
peano::MappingSpecification   myproject::mappings::Inject::ascendSpecification(int leve) const {
...
peano::MappingSpecification   myproject::mappings::Inject::descendSpecification(int leve) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidCoarseGridRaces,true);
}
