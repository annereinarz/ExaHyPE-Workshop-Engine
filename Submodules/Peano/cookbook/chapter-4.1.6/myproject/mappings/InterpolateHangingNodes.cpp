...
peano::CommunicationSpecification   myproject::mappings::InterpolateHangingNodes::communicationSpecification() const {
...
peano::MappingSpecification   myproject::mappings::InterpolateHangingNodes::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   myproject::mappings::InterpolateHangingNodes::touchVertexFirstTimeSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}
peano::MappingSpecification   myproject::mappings::InterpolateHangingNodes::enterCellSpecification(int level) const {
...
peano::MappingSpecification   myproject::mappings::InterpolateHangingNodes::leaveCellSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidFineGridRaces,true);
}
peano::MappingSpecification   myproject::mappings::InterpolateHangingNodes::ascendSpecification(int level) const {
...
peano::MappingSpecification   myproject::mappings::InterpolateHangingNodes::descendSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidCoarseGridRaces,true);
}
