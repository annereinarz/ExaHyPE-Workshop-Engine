...
peano::CommunicationSpecification   exahype::adapters::InitialPrediction::communicationSpecification() const {
...
peano::MappingSpecification   exahype::adapters::InitialPrediction::touchVertexLastTimeSpecification(int level) const {
...
peano::MappingSpecification   exahype::adapters::InitialPrediction::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialPrediction::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialPrediction::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialPrediction::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
peano::MappingSpecification   exahype::adapters::InitialPrediction::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
...
exahype::adapters::InitialPrediction::InitialPrediction() {
}
...
exahype::adapters::InitialPrediction::InitialPrediction(const InitialPrediction&  masterThread):
...
void exahype::adapters::InitialPrediction::mergeWithWorkerThread(const InitialPrediction& workerThread) {
...
void exahype::adapters::InitialPrediction::createHangingVertex(
...
void exahype::adapters::InitialPrediction::destroyHangingVertex(
...
void exahype::adapters::InitialPrediction::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialPrediction::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialPrediction::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::InitialPrediction::createCell(
...
void exahype::adapters::InitialPrediction::destroyCell(
...
#ifdef Parallel
void exahype::adapters::InitialPrediction::mergeWithNeighbour(
...
void exahype::adapters::InitialPrediction::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
...
void exahype::adapters::InitialPrediction::prepareCopyToRemoteNode(
...
void exahype::adapters::InitialPrediction::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
...
bool exahype::adapters::InitialPrediction::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialPrediction::prepareSendToMaster(
  exahype::Cell&                       localCell,
...
void exahype::adapters::InitialPrediction::mergeWithMaster(
...
void exahype::adapters::InitialPrediction::receiveDataFromMaster(
...
void exahype::adapters::InitialPrediction::mergeWithWorker(
  exahype::Cell&           localCell, 
...
void exahype::adapters::InitialPrediction::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialPrediction::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::InitialPrediction::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
...
void exahype::adapters::InitialPrediction::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
...
void exahype::adapters::InitialPrediction::beginIteration(
...
void exahype::adapters::InitialPrediction::endIteration(
  exahype::State&  solverState
) {
...
void exahype::adapters::InitialPrediction::descend(
...
void exahype::adapters::InitialPrediction::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
